...
<font color=black>机顶盒号（注意空格）<input type="text", name="stb">
<font color=black>起始日期:</font><input class="Wdate" type="text" onClick="WdatePicker()", name="datebegin">
<font color=black>结束日期:</font><input class="Wdate" type="text" onClick="WdatePicker()", name="dateend">
...
function show_select_data($head_msg,$stb,$sql,$subtype){
	    ...
	    if($num_u > 0){
	    	echo '<font  size="3" color="red"><br>用户基本信息:</br></font>';
